...
//Crear Libro
$libro = new Libro("109", "El cuento de peter pan", "Peter pan va sobre un niño que nunca crecia y luego le pasan cosas.", 15.2, "Joaquin Pereira", 
                  "978-84-376-0494-7", "Anaya", 200, "Español", "Tapa dura", 500, "20mmx20mm", "09-12-2000", "Fantasia");
...
try {
    $libro2 = new Libro("109", "El cuento de peter pan", "Peter pan va sobre un niño que nunca crecia y luego le pasan cosas.", 15.2, "Joaquin Pereira", 
                      "978-84", "Anaya", 200, "Español", "Tapa dura", 500, "20x", "09-12-2000", "Fantasia");
...
//Crear Curso
$curso = new Cursos("109", "El cuento de peter pan", "Peter pan va sobre un niño que nunca crecia y luego le pasan cosas.", 15.2, "Joaquin Pereira", 
                  200, "Fantasia", "09-12-2000", "09-12-2000", "Mañana", "Remoto", "Español");
...
try {
    $curso2 = new Cursos("109", "El cuento de peter pan", "Peter pan va sobre un niño que nunca crecia y luego le pasan cosas.", 15.2, "Joaquin Pereira", 
                      200, "Fantasia", "", "", "Mañana", "Remoto", "Español");
} catch (BuildException $ex) {
